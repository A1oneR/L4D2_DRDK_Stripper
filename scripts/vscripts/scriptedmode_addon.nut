...
AdvancedBotAI_ScriptMode_Init <- ScriptMode_Init;
//=========================================================
...
{
	local bScriptedModeValid = AdvancedBotAI_ScriptMode_Init( modename, mapname );
	
	//Include server.nut for Advanced Bot AI
